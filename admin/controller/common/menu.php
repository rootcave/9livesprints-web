...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['hfcc'] = $this->url->link('sale/halloffame_coupon', 'token=' . $this->session->data['token'], 'SSL');
		$data['popular_clipart'] = $this->url->link('sale/popular_clipart', 'token=' . $this->session->data['token'], 'SSL');
