...
<div class="panel panel-default">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-boss-top-category" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<?php foreach ($languages as $language) { ?>
					<div class="form-group">
						<div class="col-sm-11">
							<input name="boss_topcategory_module[title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($modules['title'][$language['language_id']]) ? $modules['title'][$language['language_id']] : ''; ?>" class="form-control" />
						</div>
						<div class="col-sm-1">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="boss_topcategory_module[width]" value="<?php echo isset($modules['width'])?$modules['width']:''; ?>" class="form-control" />
				<?php if ($error_width) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="boss_topcategory_module[height]" value="<?php echo isset($modules['height'])?$modules['height']:''; ?>" class="form-control" />
				<?php if ($error_height) { ?>
