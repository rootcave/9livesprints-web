...
<div class="page-header">
	...
	<div class="panel panel-default">
		<div class="panel-heading"> 
			<h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $heading_title; ?>
		</div>
	  <div class="panel-body">	
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-boss-carousel" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="boss_carousel_module[banner_id]" class="form-control">
					<?php foreach ($banners as $banner) { ?>
					<?php if (isset($modules['banner_id']) && $banner['banner_id'] == $modules['banner_id']) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="boss_carousel_module[limit]" value="<?php echo isset($modules['limit'])?$modules['limit']:''; ?>" class="form-control" />
				  <?php if ($error_limit) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				 <input type="text" name="boss_carousel_module[width]" value="<?php echo isset($modules['width'])?$modules['width']:''; ?>" class="form-control" />
				 <?php if ($error_width) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				 <input type="text" name="boss_carousel_module[height]" value="<?php echo isset($modules['height'])?$modules['height']:''; ?>" class="form-control" />
				 <?php if ($error_height) { ?>
