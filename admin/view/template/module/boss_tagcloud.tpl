...
<div class="container-fluid">
	...
	<div class="panel panel-default">
      <div class="panel-heading">			
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-boss_tagcloud" class="form-horizontal">
			...
			<div class="col-sm-10">
				<?php foreach ($languages as $language) { ?>
					<div class="form-group">
						<div class="col-sm-11">
							<input name="boss_tagcloud_module[title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($modules['title'][$language['language_id']]) ? $modules['title'][$language['language_id']] : ''; ?>" class="form-control" />
						</div>
						<div class="col-sm-1">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="boss_tagcloud_module[limit]" value="<?php echo isset($modules['limit'])?$modules['limit']:3; ?>" class="form-control" />
				<?php if ($error_limit) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="boss_tagcloud_module[min_font_size]" value="<?php echo isset($modules['min_font_size'])?$modules['min_font_size']:9; ?>" class="form-control" />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="boss_tagcloud_module[max_font_size]" value="<?php echo isset($modules['max_font_size'])?$modules['max_font_size']:25; ?>" class="form-control" />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<select name="boss_tagcloud_module[font_weight]" class="form-control">
