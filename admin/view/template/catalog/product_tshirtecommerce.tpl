...
<div id="content">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<!-- add menu design -->
            <li><a href="#tab-tshirtecommerce" data-toggle="tab">T-Shirt eCommerce</a></li>
          </ul>
          <div class="tab-content">
			...
			<!-- BEGIN:: add tab design product -->
			<div class="tab-pane" id="tab-tshirtecommerce">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="input-image">Product Design</label>
					<div class="col-sm-3">
						<div id="add_designer_product">
							<?php 
							if ($design_product_title_img != '') { 
								$design_str = explode('::', $design_product_title_img); 
								if(empty($design_str[1])) $design_str[1] = ''; 
							?>
							<img src="<?php echo $design_str[1]; ?>" class="img-responsive img-thumbnail" alt="<?php echo $design_str[0]; ?>">
							<br />
							<center><strong><?php echo $design_str[0]; ?></strong></center>
							<?php } ?>
						</div>
						<input type="hidden" value="<?php echo $design_product_id; ?>" id="_product_id" name="design_product_id">
						<input type="hidden" value="<?php echo $design_product_title_img; ?>" id="_product_title_img" name="design_product_title_img">
					</div>
					<div class="col-sm-5">
						<label for="_product_link">
						...
						<a href="javascript:void(0)" class="btn btn-danger" onclick="app.admin.clear()">Clear</a>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<?php
							...
							{
								$design_print_price = $design_str[2];
							}
							else
							{
								$design_print_price = 0;
							}
						?>
						<input type="text" onchange="setupPrice(this)" value="<?php echo $design_print_price; ?>" id="design_print_price" name="design_print_price" class="form-control">
					</div>
					<div class="col-sm-5">
						<small>This price is price of printing product when you use design template.</small>
					</div>
				</div>
			</div>
  ...
  <!-- BEGIN:: add css and js -->
  <style>	
	#products-admin > div{float: none;display: inline-block;}
  </style>
  <script type="text/javascript">
	var ajaxurl = 'index.php?route=catalog/tshirtecommerce/ajax&token=<?php echo $token; ?>';
	var tshirtURL = '<?php echo str_replace('/admin/', '', HTTP_SERVER); ?>/tshirtecommerce/';
  </script>
  <script src="<?php echo str_replace('/admin/', '', HTTP_SERVER) . '/tshirtecommerce/assets/js/app.js'; ?>" type="text/javascript"></script>
  <link href="<?php echo str_replace('/admin/', '', HTTP_SERVER) . '/tshirtecommerce/assets/css/opencart.css'; ?>" type="text/css" rel="stylesheet" />
  <!-- END:: add css and js -->
