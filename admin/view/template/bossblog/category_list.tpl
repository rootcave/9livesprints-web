            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if (isset($sort) && $sort == 'name') { ?>
                    <a href="<?php echo isset($sort_name)?$sort_name:''; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <?php echo $column_name; ?>
                    <?php } ?></td>
                  <td class="text-right"><?php if (isset($sort) && $sort == 'sort_order') { ?>
                    <a href="<?php echo isset($sort_sort_order)?$sort_sort_order:''; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
                    <?php } else { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['blog_category_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['blog_category_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['blog_category_id']; ?>" />
                    <?php } ?></td>
