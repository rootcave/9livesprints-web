...
<div class="col-md-12">
<form class="form-color" id="panel-form" method="POST" action="<?php echo site_url('index.php/settings/colors'); ?>" onsubmit="return false;">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="col-sm-2">
		...
		<div class="col-md-6">
			<p style="text-align:right;">
				<a href="#" class="btn btn-default">Video Tutorial <i class="fa fa-youtube-play icon-red"></i></a>
