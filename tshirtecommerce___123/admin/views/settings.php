...
<ul class="nav nav-tabs">
  ...
  <li class="pull-right">
	<button type="button" onclick="window.location =''" class="btn btn-default">Video Tutorial <i class="fa fa-youtube-play icon-red"></i></button>
...
<div class="tab-content">
	...
	<div class="tab-pane" id="shop">
		...
		<div class="pull-right col-md-6">
			<h4>Designer layout (menu left)</h4>
			<div class="form-group row">
				<label class="col-sm-5 control-label">Show Product Info</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Show Product Size</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Show Change Product</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Allow Add Text</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Allow Add Art</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Allow Upload</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Allow Add Team</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-5 control-label">Allow Add QRcode</label>
				<div class="col-sm-6">
	...
	<div class="tab-pane" id="language">
		...
		<ul class="edit_language" style="overflow: auto; height: 520px; display: inline-block;">
...
<script type="text/javascript">
	...
	function submit(){
		jQuery.ajax({
			type: "POST",
			url: "<?php echo site_url();?>settings/configuaration",
