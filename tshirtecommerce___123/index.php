...
<head>
	...
	<script src="<?php echo 'assets/js/language.js'; ?>"></script>	
	...
	<script type="text/javascript">
		...
		{
			jQuery('#designer-alert').html('Please go to admin and setup page default. <br /> Go to <strong>T-Shirt eCommerce > Settings</strong>').css('display', 'block');
		}
		else
		{
			urlDesign = window.parent.urlDesign;
		}
		var fbAppID = '<?php echo setValue($settings, 'facebook_api', ''); ?>';
	</script>
</head>
<body>	
