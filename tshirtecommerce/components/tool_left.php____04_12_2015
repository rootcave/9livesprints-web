...
<div class="col-left">
	...
	<div style="height:60px">
		<button style="background:rgba(0, 0, 0, 0) linear-gradient(to bottom, #09f, #027bcc) repeat scroll 0 0;width:100%;border:0px;height:40px;font-weight:bold" type="button" class="btn btn-warning btn-addcart" onclick="">Design & Color</button>
		</div>
