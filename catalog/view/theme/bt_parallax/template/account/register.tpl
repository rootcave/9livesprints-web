...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
     <div style="float:left;width:300px;"><h1><?php echo $heading_title; ?></h1></div> <div style="float:left;"><?php echo $content_top; ?></div>
	 <div style="clear:both"></div>
      <p><?php echo $text_account_already; ?></p>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal register">
	  <div class="row">
	  <div class="pull-left col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="pull-right respon-left col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <fieldset id="address">
        ...
        <br />
		<br />
		<fieldset class="boss-newsletter">
          <legend><?php echo $text_newsletter; ?></legend>
          <div class="form-group">
            <label class="col-sm-2 control-label boss-inline"><?php echo $entry_newsletter; ?></label>
            <div class="col-sm-10 boss-inline">
              <?php if ($newsletter) { ?>
