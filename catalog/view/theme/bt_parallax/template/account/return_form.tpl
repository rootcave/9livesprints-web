        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
			  ...
			  <div class="boss-small-form-control"><input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-date-format="YYYY-MM-DD" id="input-date-ordered" class="form-control" /></div> 												   
			  <div class="boss-calendar"><span class="input-group-btn">
                <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></div>
                </span></div>
            </div>
          </div>
        </fieldset>
