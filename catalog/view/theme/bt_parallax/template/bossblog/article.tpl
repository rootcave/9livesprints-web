                ...
                <div class="form-comment-container">
                    ...
                    <div id="0_comment_box" class="form-comment">
                    	  ...
                    	  <div class="form-group">
                    		  ...
                    		  <div class="boss-input"><textarea rows="2" cols="10" class="required-entry form-control" style="height:200px" title="Comment" id="comment" name="comment_content"></textarea></div>
                    	  </div>
