...
<div class="boss-custom-pro <?php echo $class_css; ?>">	
	...
	<?php $mainproduct = $product_data['mainproduct'];?>
		...
		<div class="product-thumb">
			...
			<div class="cart"><input type="button" value="<?php echo $button_cart; ?>" onclick="btadd.cart('<?php echo $mainproduct['product_id']; ?>','<?php echo $mainproduct['minimum']; ?>');" class="btn btn-primary" /></div>
		...
		<div id="boss_featured_<?php echo $module; ?>">
			...
			<div class="product-thumb">
				...
				<div class="caption">
					...
					<div class="boss-button">
					<div class="cart"><input type="button" value="<?php echo $button_cart; ?>" onclick="btadd.cart('<?php echo $product['product_id']; ?>','<?php echo $product['minimum']; ?>');" class="btn btn-primary" /></div>
