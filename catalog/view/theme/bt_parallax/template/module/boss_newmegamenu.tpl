...
<nav class="mega-menu navbar-collapse navbar-ex1-collapse collapse">
	...
	<ul class="nav nav-pills">
		...
		<?php } }?>
		<!--<li><div style="font-size:17px;"><span style="font-size:13px;color:#f06400;">Need Help?</span><br><i class="fa fa-mobile" style="font-size:17px;"></i>&nbsp;Talk to a Real Person - 200-203-4132</div></li>-->
	</ul>
</nav>
