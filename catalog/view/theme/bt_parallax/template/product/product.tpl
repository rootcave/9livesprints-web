...
<div class="container">
  ...
  <div class="row" style="margin-top:-180px">
	...
	<?php 
		if($is_hall_of_fame=='n'){
		if(isset($design_product_id) && $design_product_id > 0) {
	...
	<a id="button-design" class="btn btn-primary" href="index.php?route=tshirtecommerce/designer&product_id=<?php echo $design_product_id; ?>&parent_id=<?php echo $parent_id; ?>" style="border:0px solid #000;background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #7ec644, #50b200) repeat scroll 0 0 !important"><i class="glyphicon glyphicon-pencil"></i> Custom Your Design</a>
