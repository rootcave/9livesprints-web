...
<div class="container">
  ...
  <div class="row">
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="text-compare"><a href="<?php echo $compare; ?>" id="compare-total" class="btn btn-primary"><?php echo $text_compare; ?></a></div>
      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12">
		  ...
		  <?php 
			if($product['design_product_id']>0){
			

			if($product['is_hall_of_fame']=='y'){
		  ?>
			<a id="button-design" class="boss-name" href="<?php echo $product['href']; ?>">

		  <?php }else{ ?>

			<a id="button-design" class="boss-name" href="index.php?route=tshirtecommerce/designer&product_id=<?php echo $product['design_product_id']; ?>&parent_id=<?php echo $product['product_id']; ?>">
		  ...
		  <?php }else{ ?>
			...
			<a id="button-design" class="boss-name" href="index.php?route=tshirtecommerce/designer&product_id=<?php echo $product['design_product_id']; ?>&parent_id=<?php echo $product['product_id']; ?>"><?php echo $product['name']; ?></a>
		 ...
		 <?php } ?>
		  ...
		  ?>
				...
				<a id="button-design" class="btn btn-primary" href="<?php echo $product['href']; ?>" style="border:0px solid #000;background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #7ec644, #50b200) repeat scroll 0 0 !important">Buy Now</a>

		  <?php }else{ ?>

			<a id="button-design" class="btn btn-primary" href="index.php?route=tshirtecommerce/designer&product_id=<?php echo $product['design_product_id']; ?>&parent_id=<?php echo $product['product_id']; ?>" style="border:0px solid #000;background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #7ec644, #50b200) repeat scroll 0 0 !important"><i class="glyphicon glyphicon-pencil"></i> Custom Your Design</a>
          ...
          <?php } ?>
				...
				<?php 
				 if($product['is_hall_of_fame']=='y'){ 
						$count_halloffame = new ModelCatalogProduct($this->registry);
						$hf_product = $count_halloffame->getTotalHallofFameProduct($product['product_id']);
						if($hf_product!=''){

						echo '<br /><br /><span style="color:#006600;"><em>Total Sold : '.$hf_product.'</em></span>';
